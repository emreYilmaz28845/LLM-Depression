#!/usr/bin/env python3
"""Thin CLI for the LogReg head-attempt workflow.
...
src.features.logreg_head_campaign (shared lifecycle helpers come from
...
from src.features import logreg_head_campaign as campaign  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--job-key", default="logreg")
