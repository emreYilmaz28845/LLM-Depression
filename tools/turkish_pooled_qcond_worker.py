#!/usr/bin/env python3
"""Lifecycle and evidence CLI for Turkish question-condition head workers."""
...
def parse_args() -> argparse.Namespace:
    ...
    for name, function in (
        ("validate", validate_head_attempt),
        ("validate-job", validate_job_attempt),
        ("finish", finish_head_attempt),
    ):
...
def main() -> None:
    ...
    if args.command == "init":
        result = initialize_turkish_head_attempt(
            args.attempt_dir,
