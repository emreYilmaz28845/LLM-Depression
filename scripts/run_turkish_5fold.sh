...
CONFIGS="${CONFIGS:-$PROJECT_ROOT/configs/main/turkish_pos_only_t17_audio_only_harmonized_selmacrof1_likelihood_v1_qwen3asr.yaml $PROJECT_ROOT/configs/main/turkish_pos_only_t17_text_only_harmonized_selmacrof1_likelihood_v1_qwen3asr.yaml $PROJECT_ROOT/configs/main/turkish_pos_only_t17_audio_text_harmonized_selmacrof1_likelihood_v1_qwen3asr.yaml}"
