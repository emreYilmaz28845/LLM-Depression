...
#   CONFIGS="$PROJECT_ROOT/configs/main/daic_audio_only_harmonized_selmacrof1_likelihood_v1.yaml" \
#     RUN_NAME_PREFIX=daic_tf bash scripts/run_daic_fixed.sh

set -euo pipefail

PROJECT_ROOT="${PROJECT_ROOT:-/gpfs/projects/etur92/ozu647717/AudioLLM/LLM-Depression}"
CONFIGS="${CONFIGS:-$PROJECT_ROOT/configs/main/daic_audio_only_harmonized_selmacrof1_likelihood_v1.yaml $PROJECT_ROOT/configs/main/daic_text_only_harmonized_selmacrof1_likelihood_v1.yaml $PROJECT_ROOT/configs/main/daic_audio_text_harmonized_selmacrof1_likelihood_v1.yaml}"
FOLD="${FOLD:-0}"
