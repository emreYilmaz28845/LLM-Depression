...
# Optional: TRANSLATION_ROOT, MODEL_DIR, VENV_QWEN36, VENV_MAIN, QWEN36_REVISION,
# NLLB_MODEL, REVIEWED, FORCE_EXPORT, FORCE_RESYNC, SKIP_MANIFEST, SKIP_SERVER.
...
RUN_ROOT="$TRANSLATION_ROOT/qwen36_27b_bf16_clinical_v1/$DATASET"
