...
#   CONFIGS="$PROJECT_ROOT/configs/main/cmdc_audio_only_harmonized_selmacrof1_likelihood_v1.yaml" \
#     RUN_NAME_PREFIX=cmdc_tf bash scripts/run_cmdc_cv.sh

set -euo pipefail

PROJECT_ROOT="${PROJECT_ROOT:-/gpfs/projects/etur92/ozu647717/AudioLLM/LLM-Depression}"
CONFIGS="${CONFIGS:-$PROJECT_ROOT/configs/main/cmdc_audio_only_harmonized_selmacrof1_likelihood_v1.yaml $PROJECT_ROOT/configs/main/cmdc_text_only_harmonized_selmacrof1_likelihood_v1.yaml $PROJECT_ROOT/configs/main/cmdc_audio_text_harmonized_selmacrof1_likelihood_v1.yaml}"
